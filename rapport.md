...
- [Line](https://line.me) — Erreur SSL (certificat invalide)
...
- [Wikimapia](https://wikimapia.org/) — Erreur SSL (certificat invalide)
...
- [IntelX](https://intelx.io) — Erreur SSL (certificat invalide)
- [crt.sh](https://crt.sh/) — 502 (serveur indisponible) [via TOR]
...
- [TweetBeaver](https://tweetbeaver.com/) — Erreur SSL (certificat invalide)
...
- [Username Buddy](https://usernamebuddy.com/) — 200
...
- [Maltego](https://www.maltego.com) — 200 [via TOR]
...
- [Copernicus Open Access](https://dataspace.copernicus.eu/) — marche en navigateur (bloque IP datacenter)
...
- [CIA Reading Room](https://www.cia.gov/readingroom/) — marche en navigateur (redirect loop côté script)
...
- [OnlineSim](https://onlinesim.io/) — 200 [via TOR]
